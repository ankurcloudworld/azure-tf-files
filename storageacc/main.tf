# Define local values with the correct block name "locals"
locals {
...
# Data block to fetch existing resource group
...
# Use the appropriate resource group for the storage account
